...
it can work with [``jetty``](https://talmeym.github.io/regurgitator-extensions-web#jetty) to produce dockerized deployables you can stand up alongside your own, allowing you to test interactions with components that may not exist yet.
