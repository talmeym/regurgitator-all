...
(this example has shown programmic use of regurgitator core. to see how regurgitator can help you over http or mq, see here: [web](https://github.com/talmeym/regurgitator-extensions-web) [mq](https://github.com/talmeym/regurgitator-extensions-mq) or follow links below to some reference projects)
