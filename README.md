...
include details for other build frameworks can be found here : [``mvnrepository``](https://mvnrepository.com/artifact/uk.emarte.regurgitator/regurgitator-core){:target="_blank"}
