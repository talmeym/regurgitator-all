...
it can work with [``jetty``](https://talmeym.github.io/regurgitator-extensions-web#jetty) to produce dockerized deployables that you can stand up for quality purposes, allowing you to test interactions with components that may not exist yet.
